...
slug = "table-api-generator"
aliases = ["/posts/2016-06-10-table-api-generator/"]
...
In my holiday this spring I stumbled over a tweet from Phillip Salvisberg about his [oddgen project](https://www.oddgen.org), a SQL Developer extension to invoke dictionary-driven code generators. I was thrilled, we can have a SQL Developer integration by writing a small PL/SQL wrapper for oddgen. I finished the integration in my holiday, I could not wait.
...
You can find the sources and more informations on [GitHub](https://github.com/OraMUC/table-api-generator).
