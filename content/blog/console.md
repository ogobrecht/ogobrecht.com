...
![example log entry](/img/console-logs-single-record.png)
...
{{ img(caption="APEX error handling with ASCII art enabled", src="/img/console-apex-error-handling-function.png") }}
